...
test.describe('KAN-5: check Timesheet options enabled', () => {
    let loginPageObj;
    ...
    test('TC-001: Verify My Timesheet navigation, Edit button availability, Edit Timesheet page, Cancel, and logout', async ({ page }) => {

...
### Intelligent reuse layer: `.github/capabilities/` + colocated class index
...
- **Index**: `page-objects/<className>.index.json`, one file colocated with each Page Object (e.g. `loginPage.index.json` next to `loginPage.js`) - `className`, `file`, `methods: [{name, params}]`.

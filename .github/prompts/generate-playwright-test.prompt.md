...
---
Generate UI test cases and Playwright automation for the requirement provided below, following the UI Automation Specialist agent's full pipeline: requirements, exploration, test plan, manual test cases, page objects, then Playwright automation.

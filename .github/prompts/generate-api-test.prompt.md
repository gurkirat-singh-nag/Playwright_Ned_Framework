...
---
Generate manual test cases and API automation for the specification provided below, following the API Test Generator agent's pipeline: requirements, test design, test design validation, API capability discovery, API contract analysis, test plan, manual test cases, clients, then automation.
